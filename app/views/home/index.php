                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="ltn__banner-item">
                                <div class="ltn__banner-img">
                                    <a href="shop.html"><img src="<?php echo _WEB_ROOT ?><?php echo $item['img'] ?>" alt="Banner Image"></a>
                                </div>
                            </div>
                        </div>
                    <?php
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                            <div class="ltn__product-item text-center">
                                <div class="product-img">
                                    <a href="product-details.html"><img src="<?php echo _WEB_ROOT ?> <?php echo $nai['img'] ?>" alt="#"></a>
            ...
            <div class="container">
                ...
                <div class="row ltn__product-slider-item-four-active slick-arrow-1">
                    ...
                    <div class="col-12">
                        <div class="ltn__product-item text-center">
                            <div class="product-img">
                                <a href="product-details.html"><img src="<?php echo _WEB_ROOT ?><?php echo $tp['img']?>" alt="#"></a>
                                <div class="product-badge">
                                    <ul>
                                        <li class="<?php 
                                            if($tp['Hot'] == 1)
