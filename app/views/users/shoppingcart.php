    ...
    <div id="top" class="ltn__breadcrumb-area ltn__breadcrumb-area-4 ltn__breadcrumb-color-white---">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                    <div class="shoping-cart-inner">
                        <div class="shoping-cart-table">
                            ...
                            <div class="row align-items-center p-1 border border-secondary rounded mb-2">
                                <div class="col-md-1 cart-product-remove">
                                    <i class="fa-solid fa-trash-can"></i>
                                </div>
                                <div class="col-md-2">
                                    <a href="product-details.html"><img style="height: 70px" src="<?php echo _WEB_ROOT ?>/public/assets/clients/img/product/1.png" alt="#"></a>
                                </div>
                                <div class="col-md-3">
                            ...
                            <div class="cart-coupon d-flex pt-2 align-items-center">
                                <input type="text" name="cart-coupon" placeholder="Coupon code">
                                <button type="submit" class="btn theme-btn-2 btn-effect-2">Apply Coupon</button>
                                <span class="text-success" style="font-weight: bold;">Áp Dụng Mã Thành Công!</span>
                            </div>
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><strong>633.00K</strong></td>
                                    </tr>
                                </tbody>
                            </table>
                            <div class="btn-wrapper text-right">
                                <a href="checkout.html" class="theme-btn-1 btn btn-effect-1">Thanh Toán (chuyển sang trang thanh toán)</a>
                            </div>
                        </div>
                    </div>
                </div>
