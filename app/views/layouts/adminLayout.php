...
<head>
    ...
    <!-- Bootstrap Css -->
    <link href="<?php echo _WEB_ROOT ?>/public/assets/admin/css/bootstrap.min.css" id="bootstrap-style" rel="stylesheet" type="text/css" />
    <!-- Icons Css -->
    <link href="<?php echo _WEB_ROOT ?>/public/assets/admin/css/icons.min.css" rel="stylesheet" type="text/css" />
    <!-- App Css-->
    <link href="<?php echo _WEB_ROOT ?>/public/assets/admin/css/app.min.css" id="app-style" rel="stylesheet" type="text/css" />
...
<body>
                ...
                <div class="d-flex">
                 ...
                 <div class="navbar-brand-box">
                    <a href="index.html" class="logo logo-dark">
                        ...
                        <span class="logo-lg">
                            <img src="<?php echo _WEB_ROOT?>/public/assets/admin/images/logo-dark.png" alt="" height="20">
                        </span>
                    </a>
                    ...
                    <a href="index.html" class="logo logo-light">
                        ...
                        <span class="logo-lg">
                            <img src="<?php echo _WEB_ROOT?>/public/assets/admin/images/logo-light.png" alt="" height="20">
                        </span>
                    </a>
                </div>
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-none d-md-block ms-2">
                        <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="me-2" src="<?php echo _WEB_ROOT ?>/public/assets/admin/images/flags/us.jpg" alt="Header Language" height="16"> English <span class="mdi mdi-chevron-down"></span>
                        </button>
                        <div class="dropdown-menu dropdown-menu-end">

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="<?php echo _WEB_ROOT?>/public/assets/admin/images/flags/germany.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle"> German </span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="<?php echo _WEB_ROOT?>/public/assets/admin/images/flags/italy.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle"> Italian </span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="<?php echo _WEB_ROOT?>/public/assets/admin/images/flags/french.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle"> French </span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="<?php echo _WEB_ROOT?>/public/assets/admin/images/flags/spain.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle"> Spanish </span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="<?php echo _WEB_ROOT?>/public/assets/admin/images/flags/russia.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle"> Russian </span>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                            ...
                            <div data-simplebar style="max-height: 230px;">
                                ...
                                <a href="" class="text-reset notification-item">
                                    <div class="media">
                                        <img src="<?php echo _WEB_ROOT?>/public/assets/admin/images/users/avatar-3.jpg"
                                ...
                                <a href="" class="text-reset notification-item">
                                    <div class="media">
                                        <img src="<?php echo _WEB_ROOT?>/public/assets/admin/images/users/avatar-4.jpg"
                                            class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="media-body">
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="rounded-circle header-profile-user" src="<?php echo _WEB_ROOT?>/public/assets/admin/images/users/avatar-7.jpg"
                                alt="Header Avatar">
        ...
        <div class="vertical-menu">
            ...
            <div data-simplebar class="h-100">
                ...
                <div class="user-sidebar text-center">
                    <div class="dropdown">
                        <div class="user-img">
                            <img src="<?php echo _WEB_ROOT?>/public/assets/admin/images/users/avatar-7.jpg" alt="" class="rounded-circle">
                                        ...
                                        <ul class="list-unstyled activity-wid mb-0">
                                            ...
                                            <li class="activity-list activity-border">
                                                <div class="activity-icon avatar-sm">
                                                  ...
                                                  <img src="<?php echo _WEB_ROOT?>/public/assets/admin/images/users/avatar-7.jpg" class="avatar-sm rounded-circle" alt="">
                                            ...
                                            <div class="carousel-inner">
                                                ...
                                                <div class="carousel-item active">
                                                    <div class="row align-items-center mb-5">
                                                        <div class="col-md-4">
                                                            <img src="<?php echo _WEB_ROOT?>/public/assets/admin/images/product/img-3.png"
                                                ...
                                                <div class="carousel-item">
                                                    <div class="row align-items-center mb-5">
                                                        <div class="col-md-4">
                                                            <img src="<?php echo _WEB_ROOT?>/public/assets/admin/images/product/img-5.png"
                                                                class="img-fluid me-3" alt="">
                                                        </div>
                                                        <div class="col-md-7 offset-md-1">
                                                ...
                                                <div class="carousel-item">
                                                    <div class="row align-items-center mb-5">
                                                        <div class="col-md-4">
                                                            <img src="<?php echo _WEB_ROOT?>/public/assets/admin/images/product/img-1.png"
                                                                class="img-fluid me-3" alt="">
                                                        </div>
                                                        <div class="col-md-7 offset-md-1">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-centered table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>#2356</td>
                                                        <td><img src="<?php echo _WEB_ROOT?>/public/assets/admin/images/product/img-7.png" width="42" class="me-3" alt="">Green Chair</td>
                                                    ...
                                                    <tr>
                                                        <td>#2564</td>
                                                        <td><img src="<?php echo _WEB_ROOT?>/public/assets/admin/images/product/img-8.png" width="42" class="me-3" alt="">Office Chair</td>
                                                        <td>Alfred Gordon</td>
                                                        <td>$242.00</td>
                                                        <td>54</td>
                                                        <td><span
                                                    ...
                                                    <tr>
                                                        <td>#2125</td>
                                                        <td><img src="<?php echo _WEB_ROOT?>/public/assets/admin/images/product/img-10.png" width="42" class="me-3" alt="">Gray Chair</td>
                                                        <td>Keena Reyes</td>
                                                        <td>$320.00</td>
                                                        <td>65</td>
                                                        <td><span
                                                    ...
                                                    <tr>
                                                        <td>#8587</td>
                                                        <td><img src="<?php echo _WEB_ROOT?>/public/assets/admin/images/product/img-11.png" width="42" class="me-3" alt="">Steel Chair</td>
                                                    ...
                                                    <tr>
                                                        <td>#2354</td>
                                                        <td><img src="<?php echo _WEB_ROOT?>/public/assets/admin/images/product/img-12.png" width="42" class="me-3" alt="">Home Chair</td>
                                                        <td>Joann Wiliams</td>
                                                        <td>$320.00</td>
                                                        <td>25</td>
                                                        <td><span
    ...
    <div class="right-bar">
        <div data-simplebar class="h-100">
            ...
            <div class="p-4">
                <div class="mb-2">
                    <img src="<?php echo _WEB_ROOT?>/public/assets/admin/images/layouts/layout-1.jpg" class="img-fluid img-thumbnail" alt="layout-1">
                </div>
                ...
                <div class="mb-2">
                    <img src="<?php echo _WEB_ROOT?>/public/assets/admin/images/layouts/layout-2.jpg" class="img-fluid img-thumbnail" alt="layout-2">
                </div>
                <div class="form-check form-switch mb-3">
                ...
                <div class="mb-2">
                    <img src="<?php echo _WEB_ROOT?>/public/assets/admin/images/layouts/layout-3.jpg" class="img-fluid img-thumbnail" alt="layout-3">
                </div>
    ...
    <!-- JAVASCRIPT -->
    <script src="<?php echo _WEB_ROOT?>/public/assets/admin/libs/jquery/jquery.min.js"></script>
    <script src="<?php echo _WEB_ROOT?>/public/assets/admin/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="<?php echo _WEB_ROOT?>/public/assets/admin/libs/metismenu/metisMenu.min.js"></script>
    <script src="<?php echo _WEB_ROOT?>/public/assets/admin/libs/simplebar/simplebar.min.js"></script>
    <script src="<?php echo _WEB_ROOT?>/public/assets/admin/libs/node-waves/waves.min.js"></script>

    <!-- apexcharts -->
    <script src="<?php echo _WEB_ROOT?>/public/assets/admin/libs/apexcharts/apexcharts.min.js"></script>

    <!-- Plugins js-->
    <script src="<?php echo _WEB_ROOT?>/public/assets/admin/libs/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="<?php echo _WEB_ROOT?>/public/assets/libs/admin/admin-resources/jquery.vectormap/maps/jquery-jvectormap-world-mill-en.js"></script>
