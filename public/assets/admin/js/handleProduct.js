  ...
  $(".btnDisableCustomer").on("click", function () {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        if (response == "pass") {
          alert("Success");
          window.location.href = webroot + "/fiama/admin/customer?action=profile&id=" + customer_id;
        } else {
          alert("An error occurred! Please try again later!");
        }
      },
  ...
  $(".btnDisableEmployee").on("click", function () {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        if (response == "pass") {
          alert("Success");
          window.location.href = webroot + "/fiama/admin/employee?action=profile&id=" + employee_id;
        } else {
          alert("An error occurred! Please try again later!");
        }
      },
