...
$(document).ready(function () {
    ...
    if ($(window).width() >= 768) {
        ...
        $("#sidebar-toggler").on("click", function () {
            ...
            if (body.hasClass("ec-sidebar-fixed") || body.hasClass("ec-sidebar-static")) {
    ...
    var responsiveDataTable = $("#responsive-data-table-products");
    if (responsiveDataTable.length !== 0) {
        responsiveDataTable.DataTable({
            aLengthMenu: [
                [20, 30, 50, 75, -1],
    ...
    $("#responsive-data-table-products tfoot th").each(function () {
        var title = $(this).text();
